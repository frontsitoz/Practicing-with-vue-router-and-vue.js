...
await router.isReady();
    ...
    expect(wrapper.find('h1').text()).toContain('Pokémon #150')
    expect(wrapper.html()).toContain('https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/150.svg')
});
